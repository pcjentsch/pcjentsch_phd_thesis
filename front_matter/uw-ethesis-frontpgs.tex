...
% -------------------------------
  ...
  \begin{itemize}
   ...
   \item Chapter \ref{ch3}: The work in this chapter is based upon a manuscript accepted for publication in \textit{Theoretical Ecology}. All authors conceived ideas for the study. PCJ designed and coded the model, performed
