...
\section{} 
We developed three simple models of coupled human-environment systems. The simplicity of these models allowed us to understand them using computational techniques. In particular, we can use these models to compare methods of mitigation for coupled infectious processes.The results obtained from these analyses are novel..gs
% \begin{itemize}
