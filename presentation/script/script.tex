...
To address these questions we used data obtained from park reservation systems by the canadian forest service that show the rough frequency of recreational camping trips. We network was used in an adaption of a metapopulation model by Barlow et al.
