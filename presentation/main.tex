...
\begin{frame}{Coupled systems}
    \begin{columns}
        \begin{column}[]{0.65\textwidth}
            \begin{itemize}
                \item Coupling can often dramatically affect stability, e.g. Kapitza's pendulum 
                \item Human-environment systems focus on dynamics of humanity and the environment viewed as a whole
                \item My thesis demonstrates that this perspective provides useful answers to important problems
            \end{itemize}
        \end{column}
