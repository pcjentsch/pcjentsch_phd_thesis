    ...
    \begin{columns}
        \begin{column}[]{0.65\textwidth}
            \begin{itemize}
                ...
                \item My thesis attemps to show that this perspective provides useful answers to important problems
            \end{itemize}
        \end{column}
        \begin{column}[]{0.3\textwidth}
            \begin{figure}
                ...
                \caption{Kapitza's pendulum\\
                 \scriptsize{\textit{Source: Chris Burks}}}                
            \end{figure}
...
\begin{frame}{Results}
    \begin{figure}
        ...
        \caption{FTP most effective with small   a) $\tau = 0.15, m = 8$, b) with $\tau = 0.15, m = 8$ applied every 5 years, c) controlled burning with $\tau = 0.15, m = 8$,  with respect to burning rates $\alpha_1,\alpha_2$.}
    \end{figure}
\end{frame} 
\begin{frame}{Results}
    \begin{figure}
