...
Transmission dynamics are given by a SEPAIR model \cite{wu2006reducing}, modified to take population adherence to NPIs and school/workplace closure into account, and divided into age classes $i \in [1,16]$, where each age class contains a 5 year cohort, except for the oldest age group which comprises the ages $75$ and over. Other structure in the population, such as family structure, was not included in the model for simplicity. 
