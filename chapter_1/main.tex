...
\tiny
 \centering
  ...
  $ t_{switch} $ & Beginning of second wave & $160 $ days &  see Methods & Eq. \ref{second_wave}\\ 
  $ t_{delay} $ & Delay in impact of interventions on transmission & $28$ days &  \cite{li2020temporal} &  Eqs. \ref{cs_eqn},\ref{cw_eqn} \\ 
  $k_s$ & Rate of change from first to second wave & $0.05$ &  see Methods &  Eq.\ref{second_wave} \\
