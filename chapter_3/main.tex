...
\begin{figure}
    \begin{tikzpicture}
    \matrix (A) [matrix of nodes,nodes={draw, minimum size=.65cm, text width=3cm,align=center}] at (0,1)
    {
        Grey snags, $I_{n-2}$\\
        Red snags, $I_{n-1}$\\
    ...
    \matrix (B) [matrix of nodes,nodes={draw, minimum size=.65cm, text width=3.5cm,align=center}] at (6,1)
    {
        Red snags\\
        MPB Infestation\\
        Growth\\
    ...
    \matrix (C) [matrix of nodes,nodes={draw, minimum size=.65cm, text width=3cm,align=center}] at (12,1)
    {
        Grey snags, $I_{n-1}$\\
        Red snags, $I_{n}$\\
